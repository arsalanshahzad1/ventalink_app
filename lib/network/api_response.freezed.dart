...
class _$ERRORImpl implements ERROR {
  const _$ERRORImpl({required this.message, this.statusCode});
  ...
  @override
  String toString() {
    return 'NetworkResponse.error(message: $message, statusCode: $statusCode)';
  }
...
abstract class ERROR implements NetworkResponse {
  const factory ERROR({required final String message, final int? statusCode}) =
      _$ERRORImpl;
